...
mnist = input_data.read_data_sets("F:/dataset/mnist", one_hot=True)
...
x = tf.placeholder("float", [None, n_input])  # n 行784列
y = x  # 从编码到解码，所以需要输出还是原样
